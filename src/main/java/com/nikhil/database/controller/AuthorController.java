...
import com.nikhil.database.mappers.Impl.AuthorMapper;
...
public class AuthorController {
    ...
    public ResponseEntity<AuthorDto> createAuthor(@RequestBody AuthorDto author)
    {
        ...
        AuthorEntity authorTemp = authorService.save(authorEntity);
        return new ResponseEntity<>(authorMapper.mapTo(authorTemp), HttpStatus.CREATED);
    }
    ...
    public List<AuthorDto> getAuthors()
    {
        ...
        return authors.stream()
                .map(author -> authorMapper.mapTo(author))
            ...
            @RequestBody AuthorDto authorDto)
    {
        ...
        AuthorEntity authorTemp = authorService.save(authorEntity);
        return new ResponseEntity<>(authorMapper.mapTo(authorTemp), HttpStatus.OK);
            ...
            @RequestBody AuthorDto authorDto)
    {
        ...
        authorDto.setId(id);
        AuthorEntity authorEntity = authorMapper.mapFrom(authorDto);
        AuthorEntity authorTemp = authorService.partialUpdate(id, authorEntity);
        return new ResponseEntity<>(authorMapper.mapTo(authorTemp), HttpStatus.OK);
